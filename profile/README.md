...
Instead of a black-box "AI trading bot," Messy focuses on transparent, lens-based intelligence that anyone can inspect, question, and use to inform their own decisions.

- **Token**: $MESSY (Base CA: `0x09f87f948c88848363b124c9099cbb58e4cc7cb6`)
- **Core Focus**: Agentic due diligence, lens-based market analysis, and eventually autonomous-but-constrained fund orchestration
...
- **Agentic Due Diligence Engine (Phase 2)** – A modular "lens" stack that ingests social, news, on-chain, and market data to surface structured insights, not raw noise
...
- **Phase 1 – Culture Engine**: Community, narratives, and transparency-first treasury tracking to anchor trust before automation
- **Phase 2 – Minimum Viable Intelligence (in progress)**: Lens-based Agentic Due Diligence Engine, including the [Technical Analysis Lens](https://app.messyvirgo.com/technical-analyses), [Macro Economic Lens](https://app.messyvirgo.com/macro-economics), and upcoming narrative/social lenses
- **Phase 3 – Autonomous Trader (planned)**: Math-driven portfolio optimization and live strategy execution for on-chain funds, operating under explicit risk and governance constraints
